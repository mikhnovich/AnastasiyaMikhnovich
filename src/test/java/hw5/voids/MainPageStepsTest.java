...
public class MainPageStepsTest extends TestingPreset {

    @Feature(value = "Main page")
    @Story(value = "Ability to log in and observe menu items, iFrame components")
    @Test
    public void stepsBasedApproach() {
        MainPageSteps pageSteps = new MainPageSteps(getDriver());

        pageSteps.openPage();
        pageSteps.pageTitleShouldBe("Home Page");
